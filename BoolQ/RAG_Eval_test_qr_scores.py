...
"""
    ...
    读取boolq_test_qr.csv文件，依次读取question，
...
medmaqa_train_filename = './dataset/boolq_test_qr.csv'
csv_filename = './dataset/boolq_test_qr_score.csv'
