...
"""
    ...
    读取medmaqa_test_qr.csv文件，依次读取question，
...
medmaqa_train_filename = './dataset/medmcqa_test_qr.csv'
csv_filename = './dataset/medmcqa_test_qr_score.csv'
