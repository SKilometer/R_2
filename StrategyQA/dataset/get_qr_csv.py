...
from langchain_core.callbacks import StreamingStdOutCallbackHandler, CallbackManagerForRetrieverRun
from langchain_core.prompts import PromptTemplate
import pandas as pd
from tqdm import tqdm

embeddings = OllamaEmbeddings(model="nomic-embed-text")
ollama_llm = 'llama3.3:70b'
...
def re_query(question):
    multi_template = """As an AI assistant, my role is to analyze and reframe the provided question to enhance its clarity, precision, and applicability. 
            ...
            All rewritten questions will adhere to clear and logical language, ensuring they are well-structured and practical. 
            Each rewritten question will be sequentially numbered, fully articulated, and logically organized. 
...
input_csv_path = 'strategyqa.csv'
output_csv_path = 'strategyqa_qr.csv'
